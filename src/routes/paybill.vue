<template>
            ...
            <div class="form-group">
            <input v-model="formData.account_no" type="text" id="account_no" name="account_no" placeholder="Account Number">
            </div>
            <div class="form-group">
            <input v-model="formData.bus_no" type="text" id="bus_no" name="bus_no" placeholder="Business No.">
            </div>
            <div class="form-group">
            ...
            <button type="button" class="btn btn-success" @click.prevent="payBill">Pay Bill</button>
        </form>
</template>
<script>
...
methods: {
  findAndReturnSubsequent(str, char) {
    ...
    const response = await fetch('https://sys-audit.tech/post/paybill', {
                                              method: 'POST',
                                              headers: {
