<template>
    ...
    <div class="main_container">
        ...
        <div class="icon-container">
            <i class="fa-brands fa-apple-pay" style="color: aqua;"></i>
        </div>
    </div>
      ...
      async topUp() {
        try {
          ...
          const requestBody = utils.generateHmacSignature({
            ...
            service_provider: this.formData.service_provider,
