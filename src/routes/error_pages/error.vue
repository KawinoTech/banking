<template>
    ...
    <p>Sorry, The Process Was Unsuccessful</p>
    </div>
<section>
  <div class="container">
    <div class="circle">
      <!-- You can place your icon or content inside this div -->
      <div class="icon">
        <!-- Your icon goes here -->
        <i class="fa-solid fa-xmark fa-shake"></i>
      </div>
    </div>
  </div>
</section>
...
<style scoped>
section, .message_area, .button_area {
  height: 100%;
  margin: 30px;
  display: flex;
...
.circle {
  width: 200px;
  height: 200px;
  border: 2px solid white; /* Adjust the border thickness as needed */
